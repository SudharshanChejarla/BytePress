...
//   return (
//     <div className='fixed w-full bg-neutral-950 text-gray-100 z-10 shadow-md shadow-black/40'>
//       <div className='max-w-7xl mx-auto px-4 py-3 flex items-center justify-between'>
//         {/* Logo */}
//         <Link to={'/'}>
//           <div className='md:text-2xl text-lg font-bold text-emerald-400 cursor-pointer'>
//             BytePress
//           </div>
//         </Link>
...
//               className='md:pl-10 pl-7 py-2 w-30 md:w-64 bg-neutral-800 text-gray-100 outline-none placeholder-gray-500'
//             />
//           </div>
...
//           <button
//             onClick={toggleTheme}
//             className='bg-neutral-800 text-gray-100 p-2 rounded-lg hover:bg-neutral-700'
//           >
//             {theme === 'light' ? <FaMoon /> : <FaSun />}
//           </button>

//           {/* Mobile menu button */}
//           <button onClick={() => setOpen(!open)} className='md:hidden text-gray-100'>
...
//       {/* Mobile menu */}
//       {open && (
//         <div className='md:hidden px-4 pb-4 bg-neutral-950'>
//           {links.map((link) => (
//             <Link
//               key={link}
//               to={`/${link.toLowerCase()}`}
